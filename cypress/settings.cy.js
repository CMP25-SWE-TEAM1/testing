...
describe('Verifying settings',function(){
    ...
    it('Verify Privacy and Safety setting',function() {
        ...
        cy.url().should('eq','https://www.gigachat.cloudns.org/settings/privacy_and_safety');
    }
    )
    ...
    it('Verify Accessibility setting',function() {
        ...
        cy.url().should('eq','https://www.gigachat.cloudns.org/settings/accessibility_display_and_languages');
    }
    )
    ...
    it('Verify Account information',function() {
        ...
        cy.url().should('eq','https://www.gigachat.cloudns.org/settings/account_information');
    }
    )
    ...
    it('Verify Change Password',function() {
        ...
        cy.url().should('eq','https://www.gigachat.cloudns.org/settings/change_password');
    }
    )
    ...
    it('Verify Blocked Contacts',function() {
        ...
        cy.url().should('eq','https://www.gigachat.cloudns.org/settings/blocked');
    }
    )
    ...
    it('Verify Muted Accounts',function() {
        ...
        cy.url().should('eq','https://www.gigachat.cloudns.org/settings/muted');
    }
    )
    ...
    it('Verify Display',function() {
        ...
        cy.url().should('eq','https://www.gigachat.cloudns.org/settings/display');
    }
    )
})