...
export default function () {
  group("Verify search", function(){
    const url = 'http://backend.gigachat.cloudns.org/api/user/search?type=user&word=m';
...
export function handleSummary(data) {
  return {
    ...
    "SearchReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);