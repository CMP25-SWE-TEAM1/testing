...
export default function () {
  group("Get user likes", function () {
    ...
    const url = `https://backend.gigachat.cloudns.org/api/profile/Hima11/likes`;
...
export function handleSummary(data) {
  return {
    ...
    "getUserLikesReport.json": JSON.stringify(data), //the default data object
  };
}
