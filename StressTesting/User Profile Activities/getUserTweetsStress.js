...
export default function () {
  group("Get user Tweets", function () {
    const authToken =
    ...
    const url = `https://backend.gigachat.cloudns.org/api/profile/Hima11/tweets`;
...
export function handleSummary(data) {
  return {
    ...
    "getUserTweetsReport.json": JSON.stringify(data), //the default data object
  };
}
