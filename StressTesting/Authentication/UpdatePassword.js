...
export default function () {
  group("Verify updating password", function(){
    const url = 'http://backend.gigachat.cloudns.org/api/user/updatepassword/';
  
  const payload = JSON.stringify({
    oldPassword: 'alhamdulillah',
...
export function handleSummary(data) {
  return {
    ...
    "UpdatePasswordReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);