...
export default function () {
  group("Verify assigning username", function(){
    const url = 'http://backend.gigachat.cloudns.org/api/user/updateusername/';
  
  const payload = JSON.stringify({
    newUsername: 'mahmoud_ossama'
  });
...
export function handleSummary(data) {
  return {
    ...
    "UpdateUsernameReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);