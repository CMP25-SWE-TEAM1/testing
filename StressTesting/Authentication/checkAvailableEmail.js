...
export default function getToken() {
  const url = 'http://backend.gigachat.cloudns.org/api/user/checkAvailableEmail';
  
  const payload = JSON.stringify({
    email: 'mahmoud.khatab13@gmail.com'
  });
...
export function handleSummary(data) {
  return {
    ...
    "checkAvailableEmailReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);