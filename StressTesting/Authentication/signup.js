...
export default function () {
  group("Checking signup credentials", function(){
    const url = 'http://backend.gigachat.cloudns.org/api/user/signup';
  
  const payload = JSON.stringify({
    nickname: 'Mahmoud Ossama',
...
export function handleSummary(data) {
  return {
    ...
    "signupReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);