...
export default function getToken() {
  group("Checking verify email", function(){
    const url = 'http://backend.gigachat.cloudns.org/api/user/verifyemail';
  
  const payload = JSON.stringify({
    verifyEmailCode: 'dead',
...
export function handleSummary(data) {
  return {
    ...
    "VerifyEmailReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);