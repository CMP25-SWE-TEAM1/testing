...
export default function getToken() {
  group("Checking update email", function(){
    const url = 'http://backend.gigachat.cloudns.org/api/user/updateemail';
...
export function handleSummary(data) {
  return {
    ...
    "UpdateEmailReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);