...
export default function getToken() {
  const url = 'http://backend.gigachat.cloudns.org/api/user/checkAvailableUsername/';
  
  const payload = JSON.stringify({
    username: '7oda_needs_a_break'
  });
...
export function handleSummary(data) {
  return {
    ...
    "CheckAvailableUsernameReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);