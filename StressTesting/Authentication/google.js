...
export default function () {
  group("check for the google url", function(){
    const url = 'http://backend.gigachat.cloudns.org/auth/google';
...
export function handleSummary(data) {
  return {
    ...
    "GoogleReport.json": JSON.stringify(data), //the default data object
  };
}
  //sleep(1);