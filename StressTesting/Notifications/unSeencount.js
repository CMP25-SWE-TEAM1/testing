...
export default function getToken() {
  group("Verify unseen notifications", function(){
    const url = 'http://backend.gigachat.cloudns.org/api/user/notifications/unseenCount';
...
export function handleSummary(data) {
  return {
    ...
    "UnseenNotificationsReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);