...
export default function getToken() {
  group("Verify all notifications", function(){
    const url = 'http://backend.gigachat.cloudns.org/api/user/notifications?page=1&count=30';
...
export function handleSummary(data) {
  return {
    ...
    "AllNotificationsReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);