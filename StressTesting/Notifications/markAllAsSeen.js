...
export default function getToken() {
  group("Verify mark seen notifications", function(){
    const url = 'http://backend.gigachat.cloudns.org/api/user/notifications/markAllAsSeen';
...
export function handleSummary(data) {
  return {
    ...
    "MarkAllNotificationsReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);