...
export default function () {
  group("Verify all trends", function(){
    const url = 'http://backend.gigachat.cloudns.org/api/trends/all?page=1&count=20';
...
export function handleSummary(data) {
  return {
    ...
    "trendsReport.json": JSON.stringify(data), //the default data object
  };
} 
  //sleep(1);